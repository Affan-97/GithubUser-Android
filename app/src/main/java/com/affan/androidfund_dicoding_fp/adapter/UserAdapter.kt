...
class UserAdapter(private val listUser: List<ItemsItem>,val clickListener:(ItemsItem)->Unit): RecyclerView.Adapter<UserAdapter.ListViewHolder>() {

    class ListViewHolder(private val binding: ItemRowBinding, private val clickListener: (ItemsItem) -> Unit) : RecyclerView.ViewHolder(binding.root) {
